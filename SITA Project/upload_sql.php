<?php
    ...
    if(isset($_POST['submit']))
    {
        if(!empty($_FILES['file']['name']))
        {
                    ...
                    while(($line = fgetcsv($csvFile,0,";")) !== FALSE)
                    {
                        ...
                        if(!empty(mysql_num_rows($prevResult)))
                        {
                            mysql_query("UPDATE site 
                                ...
                                mysql_query("UPDATE identitas_pemilik
                                SET
                                ...
                                mysql_query("UPDATE ijin_dephub
                                SET
                                ...
                                mysql_query("UPDATE ijin_genset
                                SET
                                ...
                                mysql_query("UPDATE ijin_prinsip
                                SET
            ...
            {
                $qstring = '?status=invalid_ext';
                echo "<script type='text/javascript'>alert('Ekstensi Data tidak sesuai(Bukan .csv)');</script>";
            }
        }
        else
        {
