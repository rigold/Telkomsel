...
--
-- Host: 127.0.0.1
-- Generation Time: 03 Agu 2017 pada 05.49
...
(54321, '54321', 'Neji Hyuga', '1501134791.pngNeji-Hyuga.png', 'Staff Junior', 'User'),
(99999, 'admin', 'Admin 1', '1501134783.jpgwanpan.jpg', 'Administrator Web', 'Admin');
...
--
ALTER TABLE `ho`
  MODIFY `no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=886;
--
-- AUTO_INCREMENT for table `identitas_pemilik`
--
ALTER TABLE `identitas_pemilik`
  MODIFY `no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=885;
--
...
--
ALTER TABLE `ijin_genset`
  MODIFY `no` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=884;
--
