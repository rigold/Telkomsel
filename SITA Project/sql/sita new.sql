...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Jul 2017 pada 06.20
...
(0, 0x62616e313233, '0000-00-00', '0000-00-00', '0000-00-00', 0x2d);
...
(0, 0x62616e313233, 0, '-', '-', '-', '-', '-', '-', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', 'Ada', '', 'Ada');
...
('-', 0x62616e313233, '0000-00-00', '0000-00-00');
...
('-', 0x62616e313233, 0x2d, 0x2d, 0x2d, '0000-00-00', '0000-00-00', '0000-00-00');
...
('-', 0x62616e313233, 0, '0000-00-00', '0000-00-00', 0x2d, 0, 0, 'PBB1500437183.', 0, 0x2d, 0, 0);
...
(0x3131313131, '-', 0x2d, 0x42656c69, 0x2d, 0x2d, 'Bangkalan', 0x2d, 0x2d, '-', 0, 0, '0000-00-00', '-', '-', '-', 0, '-', '-', '-', '-', '-', 'DT1500437219.', 'PL1500437219.', 'SBL1500437219.', '0000-00-00', '0000-00-00', 0, '-', 0, '-', 0, 0x2d, '0000-00-00', '-', '0000-00-00', 0, 0x2d, '0000-00-00', 0x2d20, 0x2d, 0x2d, 'Cs1500437219.', 0x2d),
(0x62616e313233, '-', 0x2d, 0x42656c69, 0x2d, 0x2d, 'Bangkalan', 0x2d, 0x2d, '-', 0, 0, '0000-00-00', '-', '-', '-', 0, '-', '-', '-', '-', '-', 'DT1500437183.', 'PL1500437183.', 'SBL1500437183.', '0000-00-00', '0000-00-00', 0, '-', 0, '-', 0, 0x2d, '0000-00-00', '-', '0000-00-00', 0, 0x2d, '0000-00-00', 0x2d20, 0x2d, 0x2d, 'Cs1500437183.', 0x2d),
(0x6d6c67323133, '-', 0x2d, 0x42656c69, 0x2d, 0x2d, 'Bangkalan', 0x2d, 0x2d, '-', 0, 0, '0000-00-00', '-', '-', '-', 0, '-', '-', '-', '-', '-', 'DT1500437651.', 'PL1500437651.', 'SBL1500437651.', '0000-00-00', '0000-00-00', 0, '-', 0, '-', 0, 0x2d, '0000-00-00', '-', '0000-00-00', 0, 0x2d, '0000-00-00', 0x2d20, 0x2d, 0x2d, 'Cs1500437651.', 0x2d);
...
('-', 0x62616e313233, 0x2d, 'RPM1500437183.', 0, 0, '0000-00-00');
...
--
ALTER TABLE `identitas_pemilik`
  ADD CONSTRAINT `fk_ip_site` FOREIGN KEY (`sites_id`) REFERENCES `site` (`sites_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `ijin_dephub`
--
ALTER TABLE `ijin_dephub`
  ADD CONSTRAINT `fk_id_site` FOREIGN KEY (`sites_id`) REFERENCES `site` (`sites_id`);

--
-- Ketidakleluasaan untuk tabel `ijin_genset`
--
ALTER TABLE `ijin_genset`
  ADD CONSTRAINT `fk_ig_site` FOREIGN KEY (`sites_id`) REFERENCES `site` (`sites_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `ijin_prinsip`
--
ALTER TABLE `ijin_prinsip`
  ADD CONSTRAINT `fk_prinsip_site` FOREIGN KEY (`sites_id`) REFERENCES `site` (`sites_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `ijin_ptt`
--
ALTER TABLE `ijin_ptt`
  ADD CONSTRAINT `fk_ptt_site` FOREIGN KEY (`sites_id`) REFERENCES `site` (`sites_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `skrd_rpm`
  ADD CONSTRAINT `fk_skrd_site` FOREIGN KEY (`sites_id`) REFERENCES `site` (`sites_id`) ON DELETE CASCADE ON UPDATE CASCADE;
